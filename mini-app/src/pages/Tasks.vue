<template>
  <div class="space-y-8">
    <!-- Hero Section -->
    <div class="relative overflow-hidden rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-br from-blue-600 to-indigo-700 text-white p-5 md:p-10 shadow-2xl mb-6 md:mb-10 sticky top-0 md:relative z-30">
      <!-- Background Decorative Elements -->
      <div class="absolute top-0 right-0 -mt-20 -mr-20 w-64 md:w-96 h-64 md:h-96 bg-white/10 rounded-full blur-3xl"></div>
      <div class="absolute bottom-0 left-0 -mb-20 -ml-20 w-56 md:w-72 h-56 md:h-72 bg-blue-400/20 rounded-full blur-2xl"></div>
      
      <div class="relative z-10">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6 mb-6 md:mb-8">
          <div>
            <h1 class="text-2xl md:text-4xl font-black tracking-tight mb-1">My Tasks</h1>
            <p class="text-blue-100 text-xs md:text-base font-medium opacity-90">Manage and track your daily activities.</p>
          </div>
          <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 md:gap-4">
            <div class="relative group">
              <input
                ...
                class="pl-10 md:pl-12 pr-4 md:pr-6 py-2 md:py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl md:rounded-2xl focus:ring-2 focus:ring-white/50 outline-none transition-all w-full sm:w-64 text-white placeholder-blue-200 text-xs md:text-base"
              />
              <svg
                class="w-4 h-4 md:w-5 md:h-5 text-blue-200 absolute left-3.5 md:left-4 top-2.5 md:top-3.5 group-focus-within:text-white transition-colors"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <button
              ...
              class="bg-white text-blue-600 px-4 md:px-6 py-2 md:py-3 rounded-xl md:rounded-2xl font-bold hover:bg-blue-50 transition-all flex items-center justify-center space-x-2 shadow-xl shadow-blue-900/20 group text-xs md:text-base"
            >
              <svg
        ...
        <div class="flex items-center space-x-3 overflow-x-auto pb-2 md:pb-0 no-scrollbar">
          <div class="bg-white/10 backdrop-blur-md border border-white/20 px-3 md:px-5 py-1.5 md:py-2.5 rounded-xl md:rounded-2xl flex items-center space-x-2 md:space-x-3 whitespace-nowrap">
            <span class="text-base md:text-2xl font-black">{{ taskStore.tasks.length }}</span>
            <span class="text-[8px] md:text-xs font-bold uppercase tracking-widest opacity-80">Total</span>
          </div>
          <div class="bg-white/10 backdrop-blur-md border border-white/20 px-3 md:px-5 py-1.5 md:py-2.5 rounded-xl md:rounded-2xl flex items-center space-x-2 md:space-x-3 whitespace-nowrap">
            <span class="text-base md:text-2xl font-black text-emerald-300">{{ taskStore.tasks.filter(t => t.status === 'completed').length }}</span>
            <span class="text-[8px] md:text-xs font-bold uppercase tracking-widest opacity-80">Done</span>
          </div>
          <div class="bg-white/10 backdrop-blur-md border border-white/20 px-3 md:px-5 py-1.5 md:py-2.5 rounded-xl md:rounded-2xl flex items-center space-x-2 md:space-x-3 whitespace-nowrap">
            <span class="text-base md:text-2xl font-black text-rose-300">{{ taskStore.tasks.filter(t => t.status === 'pending').length }}</span>
            <span class="text-[8px] md:text-xs font-bold uppercase tracking-widest opacity-80">Pending</span>
          </div>
        </div>
      </div>
    </div>
