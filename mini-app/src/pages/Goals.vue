<template>
  <div class="space-y-8">
    <!-- Hero Section -->
    <div class="relative overflow-hidden rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-br from-indigo-600 to-violet-700 text-white p-5 md:p-10 shadow-2xl mb-6 md:mb-10 sticky top-0 md:relative z-30">
      ...
      <div class="relative z-10">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6 mb-6 md:mb-8">
          <div>
            <h1 class="text-2xl md:text-4xl font-black tracking-tight mb-1">Goals</h1>
            <p class="text-indigo-100 text-xs md:text-base font-medium opacity-90">Focus on what matters most.</p>
          </div>
          <button
            @click="showNewGoalModal = true"
            class="bg-white text-indigo-600 px-4 md:px-6 py-2 md:py-3 rounded-xl md:rounded-2xl font-bold hover:bg-indigo-50 transition-all flex items-center justify-center space-x-2 shadow-xl shadow-indigo-900/20 group text-xs md:text-base"
          >
            <svg
        ...
        <!-- Stats Bar -->
        <div class="flex items-center space-x-3 overflow-x-auto pb-2 md:pb-0 no-scrollbar mb-4 md:mb-6">
          <div class="bg-white/10 backdrop-blur-md border border-white/20 px-3 md:px-5 py-1.5 md:py-2.5 rounded-xl md:rounded-2xl flex items-center space-x-2 md:space-x-3 whitespace-nowrap">
            <span class="text-base md:text-2xl font-black">{{ totalGoals }}</span>
            <span class="text-[8px] md:text-xs font-bold uppercase tracking-widest opacity-80">Total</span>
          </div>
          <div class="bg-white/10 backdrop-blur-md border border-white/20 px-3 md:px-5 py-1.5 md:py-2.5 rounded-xl md:rounded-2xl flex items-center space-x-2 md:space-x-3 whitespace-nowrap">
            <span class="text-base md:text-2xl font-black text-emerald-300">{{ completedGoals }}</span>
            <span class="text-[8px] md:text-xs font-bold uppercase tracking-widest opacity-80">Done</span>
          </div>
          <div class="bg-white/10 backdrop-blur-md border border-white/20 px-3 md:px-5 py-1.5 md:py-2.5 rounded-xl md:rounded-2xl flex items-center space-x-2 md:space-x-3 whitespace-nowrap">
            <span class="text-base md:text-2xl font-black text-amber-300">{{ inProgressGoals }}</span>
            <span class="text-[8px] md:text-xs font-bold uppercase tracking-widest opacity-80">Active</span>
          </div>
        </div>

        <!-- Quote -->
        <div v-if="goalStore.goals.length > 0" class="hidden md:block pt-6 border-t border-white/10">
          <p class="text-indigo-100/80 italic font-medium leading-relaxed max-w-2xl">
            "The only limit to our realization of tomorrow will be our doubts of today."
            <span class="block text-xs font-bold uppercase tracking-widest mt-2 opacity-60">— Franklin D. Roosevelt</span>
          </p>
        </div>
      </div>
    </div>
